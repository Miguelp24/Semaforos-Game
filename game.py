...
def showtabuleiro(tabuleiro):
    ...
    print('   ---------------')
    print('2  ' + printcasa(tabuleiro['2A']) + '|' + printcasa(tabuleiro['2B'])+ '|' + printcasa(tabuleiro['2C'])+ '|' + printcasa(tabuleiro['2D']))
    print('   ---------------')
